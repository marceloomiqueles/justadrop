				...
				<div id='imgHomeF'>
					<div id='contenedorBox'>
						<div id='contenedorBoxInt'>
							...
							<div id='layerBox'>
								<div id='layerBoxHead'>
									<div id='layerBoxHeadTitulo'>INDUSTRIAL</div>
									<div id='layerContIndustrial'>
										<div id='layerContTexto'>
											<p class='industrialText'>NEUTRALIZA</p>
											<ul>
												<li>Amoníaco.</li>
												<li>Mercaptano.</li>
											...
											<p class='industrialText'>REDUCE OLORES</p>
											<ul>
												<li>Lodos.</li>
												<li>Piscinas de tratamientos.</li>
												<li>Tratamiento de RILES.</li>
												<li>Proceso de curtido de cueros.</li>
												<li>Desagües</li>
											</ul>
